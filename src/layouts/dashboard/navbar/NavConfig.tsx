...
const ICONS = {
  ...
  firewall: getIcon('carbon:firewall'),
  sshKey: getIcon('vpn_key')
};
...
const navConfig = [
  ...
  // ----------------------------------------------------------------------
  {
    ...
    items: [
      ...
      { title: 'SSH Keys', path: PATH_DASHBOARD.general.ecommerce, icon: ICONS.sshKey },
      { title: 'Firewall', path: PATH_DASHBOARD.general.analytics, icon: ICONS.firewall },
    ],
  },
